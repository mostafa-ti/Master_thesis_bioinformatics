...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o SVZ24_velocyto.%j.out
#SBATCH -e SVZ24_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/SVZ24/SVZ24_count"
