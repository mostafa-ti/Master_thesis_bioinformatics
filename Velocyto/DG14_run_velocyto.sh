...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o DG14_velocyto.%j.out
#SBATCH -e DG14_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/DG14/DG14_count"
