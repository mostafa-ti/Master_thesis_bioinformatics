...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o SVZ14_velocyto.%j.out
#SBATCH -e SVZ14_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/SVZ14/SVZ14_count"
