...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o OB24_velocyto.%j.out
#SBATCH -e OB24_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/OB24/OB24_count"
