...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o OB14_velocyto.%j.out
#SBATCH -e OB14_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/OB14/OB14_count"
