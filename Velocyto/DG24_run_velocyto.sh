...
#SBATCH -p dell
#SBATCH -J velocyto
#SBATCH -o DG24_velocyto.%j.out
#SBATCH -e DG24_velocyto.%j.err
module purge
...
cellranger_output="/projects/fs1/mtorbati/Torbati/CellRanger_V6/cellranger_count/DG24/DG24_count"
